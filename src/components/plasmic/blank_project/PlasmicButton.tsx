...
// Plasmic Project: fshNQUUTM3VHchgfPz71Ms
// Component: X8LmaV7FnOC
...
import * as sty from "./PlasmicButton.module.css"; // plasmic-import: X8LmaV7FnOC/css
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__nsxda)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(projectcss.all, sty.svg__wc5WS)}
                role={"img"}
              />
            ),
